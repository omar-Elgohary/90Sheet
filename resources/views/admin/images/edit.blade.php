        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.images.update' , ['id' => $image->id])}}" class="store form-horizontal needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <x-admin.inputs.image  name="image" src="{{ $image->image }}" inValidMessage="{{ __('admin.this_field_is_required') }}" />
                                    </div>
