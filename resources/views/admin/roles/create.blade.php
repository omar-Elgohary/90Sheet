                        ...
                        <div class="card-body">
                            <form action="{{route('admin.roles.store')}}" method="post" class="needs-validation" novalidate>
                                                    ...
                                                    <div class="card overflow-hidden mb-4" style="height: 360px">
                                                        ...
                                                        <span class="me-2">
                                                             <label class="switch switch-info"  for="gtx_{{$routeKey}}">
                                                                <input type="checkbox" class="switch-input" name="permissions[]" data-parent="gtx_{{$routeKey}}" value="{{$value['as']}}" id="gtx_{{$routeKey}}"  >
                                                                <span class="switch-toggle-slider">
                                                                    <span class="switch-on"></span>
                                                                    <span class="switch-off"></span>
                                                                </span>
                                                            ...
                                                            <div class="card-header-elements ms-auto">
                                                                <label class="switch switch-info" data-parent="gtx_{{$routeKey}}">
                                                                    <input type="checkbox" class="switch-input checkChilds checkChilds_gtx_{{$routeKey}}" name="permissions[]" data-parent="gtx_{{$routeKey}}" value="{{ isset($value['as']) ? route('admin.'.$value['as']) : '' }}"  >
                                                                    <span class="switch-toggle-slider">
                                                                    <span class="switch-on"></span>
                                                                    <span class="switch-off"></span>
                                                                </span>
                                                        ...
                                                        <div class="card-body vertical-example contentHolder" id="">
                                                            @if (isset($value['child']) && count($value['child']))
                                                                @foreach ($value['child'] as $key => $child)
                                                                    @php $routeName = is_int($key) ? $value['child'][$key] : $key @endphp
                                                                    <div class="form-check form-check-success mt-3 p-0">
                                                                        <label class="switch switch-info"  for="_{{$routeName}}">
                                                                            <input type="checkbox" class="switch-input childs checkChilds_gtx_{{$routeKey}} gtx_{{$routeKey}}" name="permissions[]" data-parent="gtx_{{$routeKey}}" value="admin.{{$routeName}}" id="_{{$routeName}}">
                                                                            <span class="switch-toggle-slider">
                                                                            <span class="switch-on"></span>
                                                                            <span class="switch-off"></span>
                                                                        </span>
                                                                            <span class="switch-label">{{ __('routes.admin.' . $routeName) }} </span>
                                                                        </label>
                                                                    </div>
                                                                @endforeach
                                                            @else
                                ...
                                <div class="col-12 d-flex justify-content-center mt-3">
                                    <button type="submit" class="btn rounded-pill btn-primary m-2 submit_button">{{__('admin.add')}}</button>
