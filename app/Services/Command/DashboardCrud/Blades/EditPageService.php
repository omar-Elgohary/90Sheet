...
class EditPageService
{
     ...
     * @return void
     */
    public function createEditPage($folderName, $singleName)
    {
        // Define the path of the create.blade.php file
        $editPath = 'resources/views/admin/' . $folderName . '/edit.blade.php';

        // Copy the 'create.blade.php' file to the specified folder
        File::copy('app/Console/CommandCopys/blades/edit.blade.php', base_path($editPath));

        // Read the contents of the copied file
        $copiedContent = file_get_contents($editPath);
        ...
        file_put_contents($editPath, $updatedContent);
    }
}